...
package frc.robot.subsystems.BallHandling.Shoot;
...
public class Shooter extends SubsystemBase { // handles shooter flywheel, currently is built for CANSparkMax brushed motors which are planned to be replaced by brushless
