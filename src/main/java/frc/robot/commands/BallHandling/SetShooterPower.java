...
public class SetShooterPower extends CommandBase { // Limelight based setting shooter power. Conflicts with the current
                                                   // decision to have shooter hard-set to 0.85 power for the entire
                                                   // match.
  /**
