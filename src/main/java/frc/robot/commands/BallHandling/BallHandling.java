...
public class BallHandling extends CommandBase { // All ball-handling (ingesting, indexing) done here.
  /**
  ...
  private double delta1 = 50; // allowed variance of RPM lower threshold (in case pid controll not 100%
                              // accurate)
