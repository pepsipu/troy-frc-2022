...
public class Autonomous extends CommandBase { // Autonomous code
  /**
  ...
  public Autonomous(DriveTrain drive, ClimberArm arm, Shooter shooter, BottomIndexer bottomIndexer, TopIndexer topIndexer, Gyro gyro) {
    ...
    timer.start();
    // this.tacheo = tacheo;
    addRequirements(drive, arm, shooter, bottomIndexer, topIndexer, gyro);
  }
